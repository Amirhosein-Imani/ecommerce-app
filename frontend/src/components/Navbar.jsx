    ...
    <div className='flex items-center justify-between py-5 font-medium'>
        ...
        <div className='flex items-center gap-6'>
          ...
          <div className='group relative'>
              ...
              <div className='group-hover:block hidden drop-down-menu absolute right-0 pt-4'>
          ...
          <Link to='/cart' className='relative'>
              ...
              <p className='absolute w-4 right-[-5px] bottom-[-5px] text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]'>0</p>
